...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        service = new UserService_1.UserService();
    ...
    UserController.update = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, profilePicture, coverPicture, description, service, result, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        id = req.params.id;
                        _a = req.body, profilePicture = _a.profilePicture, coverPicture = _a.coverPicture, description = _a.description;
                        service = new UserService_1.UserService();
